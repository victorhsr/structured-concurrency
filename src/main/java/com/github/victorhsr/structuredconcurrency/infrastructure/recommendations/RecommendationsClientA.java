...
public class RecommendationsClientA {

    private static final Map<String, Recommendations> DATA_MAP;

    static {
        DATA_MAP = Map.of(
                "1", new Recommendations(List.of(new RecommendationProduct("Playstation 5 SILVER", "https://www.my-image-host/recommendation/1", "$1.00"))),
                "2", new Recommendations(List.of(new RecommendationProduct("Playstation 4 1TB", "https://www.my-image-host/recommendation/2", "$2.00"))),
                "3", new Recommendations(List.of(new RecommendationProduct("XBox 360", "https://www.my-image-host/recommendation/3", "$3.00")))
        );
    }

    @SneakyThrows
    public Recommendations getRecommendations(String productId) {
        System.out.println("RecommendationsClientA getting results...");
        Thread.sleep(150);
